...
## 5. 고찰 (Reflections)
 ...
 RV32I CPU에 APB Bus를 연결하고 주변 장치를 직접 설계·연결하는 경험을 통해 MCU에 가까운 시스템을 구현해보면서 임베디드 시스템의 구조와 동작 원리를 체감할 수 있었습니다  RV32I 명령어만 사용 가능했기 때문에 복잡한 기능 구현에 부족함을 느꼈으며, 하드웨어와 소프트웨어의 **조화로운 조합**이 필요하다는 것을 배웠습니다.
